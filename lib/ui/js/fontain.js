...
$(document).ready(function() {
  ...
  //expand first not-excluded fontdemo
  $('.accordion-section').not('.excluded').first().children('.accordion-section-header').children('.accordion-section-title').trigger("click");
  
  console.log( $('.accordion-section').not('.excluded').first().children('.accordion-section-header').children('.accordion-section-title') );
...
function initFontSizeSliders() {
  ...
  if ($('input.flowtext-fontsize').length)  {
