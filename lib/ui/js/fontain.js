...
$(document).ready(function() {
  ...
  //$('.accordion-section').not('.excluded').first().children('.accordion-section-header').children('.accordion-section-title').trigger("click");
    $('.accordion-section').not('.excluded').children('.accordion-section-header').children('.accordion-section-title').trigger("click");
  } else if(isListPage) {
...
// INIT ==============================================================================
  ...
  e.preventDefault(); 
    ...
    $('.accordion-section-content.zu input.fontdemo').css("margin-top", "" +-(hh/2)+"px");
  }
...
function open_accordion_section(elem) {    
      ...
      $('.accordion-section-content.auf input.fontdemo').css("margin-top", "" +margintop+"px");
}
